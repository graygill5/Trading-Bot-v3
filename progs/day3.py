...
# filter for only buys and the check the return for the next day
...
# calc the sharpe ratio using the 260 days in a year you can trade minus 8 days for holidays
